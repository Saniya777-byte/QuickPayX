...
import { CreditCard, Lock, Mail, AlertCircle, ArrowRight, Shield } from 'lucide-react';
        ...
        <div className="bg-[#1a1f2e] rounded-2xl p-8 shadow-lg border border-gray-800/50">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <button onClick={() => router.push('/register')} className="text-emerald-500 hover:text-emerald-400 font-semibold hover:underline transition-colors">
                Sign up
              </button>
            </p>
          </div>
